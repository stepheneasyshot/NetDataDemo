 ...
 *
 */
package com.example.netdatademo.mqtt.service;
...
public class MqttAndroidClient extends BroadcastReceiver implements
    ...
    private static final String SERVICE_NAME = "com.example.netdatademo.mqtt.service.MqttService";
    ...
    public IMqttToken connect(MqttConnectOptions options, Object userContext,
        ...
        if (mqttService == null) { // First time - must bind to the service
            ...
            if (!receiverRegistered) if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
    ...
    private void registerReceiver(BroadcastReceiver receiver) {
        ...
        myContext.registerReceiver(receiver, filter,RECEIVER_NOT_EXPORTED);
